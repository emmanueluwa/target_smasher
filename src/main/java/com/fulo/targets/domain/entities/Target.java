...
public class Target {
    ...
    public Target(UUID id, String name, String description, String why, TargetStatus status, TargetPriority priority, HitList hitList, LocalDateTime created, LocalDateTime updated) {
